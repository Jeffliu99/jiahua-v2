...
export default function DimSumCategories() {
  return (
    <section id="dim-sum-categories" className="bg-[#FAF8F5] py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl leading-8 text-gray-600">
            每一类面点都坚持手工制作，适合不同家庭早餐、聚餐和团购场景。
          </p>
        </div>

        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {dimSumCategories.map((category) => (
            <article
              key={category.title}
