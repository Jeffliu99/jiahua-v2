...
const categories = [
  {
    title: "蛋糕卷系列",
    description: "抹茶、巧克力等经典蛋糕卷。",
    image: "/images/desserts/roll-cake-series.png",
  },
  {
    title: "甜品杯系列",
    description: "草莓、芒果、紫薯等人气甜品杯。",
    image: "/images/desserts/dessert-cup-series.png",
  },
  {
    title: "现烤蛋挞",
    description: "香酥挞皮与浓郁内馅。",
    image: "/images/desserts/egg-tarts-series.png",
  },
  {
    title: "古早蛋糕系列",
    description: "红豆古早蛋糕与巧克力古早蛋糕。",
    image: "/images/desserts/castella-cake-series.png",
  },
  {
    title: "提拉米苏系列",
    description: "细腻奶香与经典可可风味。",
    image: "/images/desserts/tiramisu-series.png",
  },
  {
    title: "海苔肉松蛋糕系列",
    description: "松软蛋糕体结合海苔与肉松风味。",
    image: "/images/desserts/pork-floss-cake-series.png",
  },
  {
    title: "抹茶大福系列",
    description: "Q弹外皮搭配抹茶奶油与芝士内馅。",
    image: "/images/desserts/matcha-mochi-series.png",
  },
{
  title: "曲奇系列",
  description:
    "巧克力曲奇与特色夹心曲奇，适合下午茶与礼盒搭配。",
  image: "/images/desserts/cookie-series.png",
},
];
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#E8DCC9] bg-white shadow-xl">
            <div className="relative aspect-square md:aspect-[16/12]">
              <Image
      ...
      <section className="py-20">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <div className="rounded-[2rem] border border-[#E8DCC9] bg-white p-12 shadow-sm">
            ...
            <div className="mt-10">
              <Link href="/contact" className="rounded-full bg-[#1F4E4C] px-8 py-4 font-semibold text-white">
                预约咨询 →
              </Link>
            </div>
          </div>
