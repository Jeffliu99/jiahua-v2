...
const deliveryMeals = [
  {
    ...
    title: "Steamed Fresh Fish Meal",
    description: "A balanced set with fresh fish soup, steamed fish, vegetables, rice, and seasonal fruit.",
  },
  {
    src: "/images/meal-plans/shrimp-rice-meal.jpg",
    title: "Colorful Shrimp Stir-Fry Meal",
    description: "Fresh shrimp, seasonal vegetables, nourishing rice, and soup arranged as a complete meal set.",
  },
  {
    src: "/images/meal-plans/cantonese-postpartum-meal.jpg",
    title: "Cantonese-Style Postpartum Meal Set",
    description: "Ginger chicken, nourishing soup, two-tone rice, and refreshing side dishes in a comforting meal combination.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-2xl leading-8 text-gray-600">
              Daily meals include main dishes, soups, fruit, desserts, dim sum, and pastries. The images below show real meal combination examples.
            </p>
          </div>
