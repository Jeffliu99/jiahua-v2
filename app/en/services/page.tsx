...
export const metadata: Metadata = {
  title:
    "GTA Nutrition Meal Services｜Postpartum Meals & Family Meals｜Jiahua",
  description:
    "Jiahua provides postpartum meals, C-section recovery meals, breastfeeding meals, miscarriage recovery meals, family nutrition meals, premium custom plans and group meal services for GTA families.",
};
