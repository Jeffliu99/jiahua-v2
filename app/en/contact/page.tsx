...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://jiahuameal.com/en/contact" },
};
    ...
    <main className="bg-[#FAF8F5]">
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <h1 className="max-w-4xl text-4xl font-bold text-[#1F4E4C] md:text-6xl">Let's Find the Right Meal Program for Your Family</h1>
          <p className="mt-6 max-w-3xl text-lg leading-9 text-gray-600">Whether you are planning ahead or already welcoming your baby home, our team is here to help.</p>
        </div>
      </section>
