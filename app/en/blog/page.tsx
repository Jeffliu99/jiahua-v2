...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://jiahuameal.com/en/blog" },
};
    ...
    <main className="bg-[#FAF8F5]">
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <Link href="/blog" className="mt-8 inline-flex rounded-full bg-[#1F4E4C] px-7 py-3 font-semibold text-white hover:bg-[#173D3B]">View Chinese Blog</Link>
        </div>
      </section>
    </main>
  );
